...
import { ListaTransazioneComponent } from './components/lista-transazione/lista-transazione.component';

@Component({
  selector: 'app-root',
  imports: [RouterOutlet, ListaTransazioneComponent],
